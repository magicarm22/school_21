...
/*   Updated: 2019/09/21 14:07:16 by djast            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void		draw_buttons_on_right_panel(t_sdl *sdl)
{
	...
	r = create_sdl_rect(BUTTON_WALL_X, BUTTON_WALL_Y, BUTTON_SIZE_X, BUTTON_SIZE_Y);
...
static void		draw_input_fields_on_right_panel(t_sdl *sdl)
{
	...
	r = create_sdl_rect(BUTTON_X, INPUT_MAP_NAME_Y, INPUT_MAP_NAME_SIZE_X, BUTTON_SIZE_Y);
...
static void		draw_map_size_info(t_sdl *sdl)
{
	...
	r = create_sdl_rect(TEXT_MAP_X, TEXT_MAP_Y, TEXT_MAP_SIZE_X, TEXT_MAP_SIZE_Y);
