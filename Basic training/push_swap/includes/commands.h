...
/*   Updated: 2019/08/30 14:09:30 by djast            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				put_index_to_b_up(t_stacks *stacks, t_commands **commands,
															unsigned int index);
...
void				make_and_add_command(t_stacks *stacks,
									t_commands **commands, char *data);
void				optimizate_commands(t_commands **commands,
						char *command1, char *command2, char *command_result);
...
void				sort_many_numbers(t_stacks *stacks, unsigned int list_size,
														t_commands **commands);
